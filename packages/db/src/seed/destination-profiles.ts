...
/**
 * Demo section content for the destination shell, transplanted from the Phase 2
 * S3 front-end fixtures now that the surface is folded into the real stack. Only
 * Germany is authored (destination-level facts + the two Germany pairings); other
 * destinations and pairings intentionally have no profile and degrade to their
 * on-page scaffolds. Throwaway demo data — see docs/domain-model.md.
 */

/** Germany's destination-level sections (same for every visitor). */
export const germanyDetail: DestinationDetail = {
  quickFacts: [
    {
      label: "Capital",
      value: "Berlin",
    ...
    geography: {
      ...
      stats: [
        ...
        },
        {
          label: "Terrain",
          value: "Lowlands → Alps",
          note: "flat north, alpine south",
        },
        {
          label: "Coastline",
          value: "North & Baltic Seas",
        },
        {
          label: "Time zone",
          value: "CET (UTC+1)",
      ...
      parties: [
        {
          label: "CDU/CSU",
          value: 28,
          note: "centre-right · governing",
        },
        {
          label: "AfD",
          value: 21,
          note: "far-right · opposition",
        },
        {
          label: "SPD",
          value: 16,
          note: "centre-left · governing",
        },
        {
          label: "Greens",
          value: 12,
      ...
      timeline: [
        {
          period: "2025–",
          label: "Merz cabinet",
          note: "CDU/CSU–SPD grand coalition",
        },
        {
          period: "2021–2025",
          label: "Scholz cabinet",
          note: "SPD–Greens–FDP 'traffic light'",
        },
        {
          period: "2005–2021",
          label: "Merkel era",
          note: "CDU-led, four terms",
        },
        {
          period: "1998–2005",
          label: "Schröder cabinet",
          note: "SPD–Greens",
        },
      ],
    },
  ...
  living: {
    ...
    eatingOut: [
      ...
      {
        label: "Beer (0.5 L, bar)",
        value: "€4.50",
      },
      {
        label: "Lunch (Imbiss / menu)",
        value: "€12",
      },
      {
    ...
    essentials: [
      ...
      {
        label: "Utilities (85 m²)",
        value: "€280/mo",
        note: "heat, power, water",
      },
      {
  ...
  work: {
      ...
      lanes: [
        {
          mode: "Employee",
          burden: "≈35–40%",
          note: "tax + social, withheld at source",
        },
        {
          mode: "Freelancer",
          burden: "≈25–42%",
    ...
    credentials: {
      ...
      stats: [
        {
          label: "Regulated jobs",
          value: "Recognition required",
          tone: "warn",
        },
        {
          label: "Portal",
          value: "anerkennung-in-deutschland.de",
        },
        {
          label: "Degree check",
          value: "ANABIN database",
        },
        {
          label: "Typical time",
          value: "3–6 months",
  ...
  family: {
    ...
    reunification: {
      ...
      stats: [
        {
          label: "Core family",
          value: "Spouse + minor kids",
          tone: "pos",
        },
        {
          label: "Their work rights",
          value: "Follow the sponsor",
          tone: "pos",
        },
        {
          label: "Spouse German",
          value: "A1",
          note: "waived in many cases",
        },
        {
          label: "Income proof",
          value: "Required",
          note: "support without benefits",
        },
        {
    ...
    perks: {
      ...
      stats: [
        ...
        {
          label: "Kids' schooling",
          value: "Free & compulsory",
          tone: "pos",
        },
        {
          label: "Health cover",
          value: "Family included",
          note: "public GKV",
          tone: "pos",
        },
        {
        ...
        {
          label: "First residence",
          value: "Tied to sponsor",
        },
      ],
    },
    pets: {
      ...
      stats: [
        ...
        },
        {
          label: "Microchip",
          value: "Required",
          note: "ISO 11784/11785",
        },
        {
          label: "Rabies vaccine",
          value: "21+ days before",
        },
        {
          label: "Pets per person",
          value: "Up to 5",
        },
        {
          label: "EU pet passport",
          value: "From any EU vet",
          tone: "pos",
        },
        {
          label: "Dog tax",
...
/** Germany pairings, keyed `CITIZENSHIP/DESTINATION` (reader-specific sections). */
export const germanyPairings: Record<string, DestinationPairing> = {
  "USA/DE": {
    language: {
      official: [],
      difficulty: {
    ...
    fitsYouIf: [
      ...
      {
        text: "A close relative already has residence here",
        match: "maybe",
      },
      {
        text: "You can show steady self-employed income",
        match: "maybe",
      },
    ],
  },
